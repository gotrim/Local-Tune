...
tb_musico.hasMany(tb_tipoUsuario, {foreignKey: 'cd_tipoUsuario'});
tb_tipoUsuario.belongsToMany(tb_musico, {foreignKey: 'cd_tipoUsuario'});

tb_estabelecimento.hasMany(tb_tipoUsuario, {as:'tb_estabelecimento',foreignKey: 'cd_tipoUsuario'});
tb_tipoUsuario.belongsToMany(tb_estabelecimento, {as:'tb_estabelecimento',foreignKey: 'cd_tipoUsuario'});
